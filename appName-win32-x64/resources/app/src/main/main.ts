...
app
  ...
  .then(() => {
    ...
    ipcMain.handle('client:getByRange', async (_, low: number, high:number) => {
    ...
    ipcMain.handle('credit:delete', async (_, id: number, client_id:number) => {
    ...
    ipcMain.handle('credit:getByRange', async (_, low: number, high:number) => {
      return getOneCreditByAmountRange(low, high);
    });
    ipcMain.handle('credit:getByDate', async (_, date_low: Date, date_high:Date) => {
